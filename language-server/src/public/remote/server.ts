...
export const giveAllActions = new RequestType0<VroElementPickInfo[], void, void>("vrdev.server.giveAllActions")

export const giveActionModules = new RequestType0<VroElementPickInfo[], void, void>("vrdev.server.giveActionModules")

export const giveActionsForModule = new RequestType<string, VroElementPickInfo[], void, void>(
    "vrdev.server.giveActionsForModule"
)

export const giveAllConfigElements = new RequestType0<VroElementPickInfo[], void, void>(
    "vrdev.server.giveAllConfigElements"
)

export const giveConfigCategories = new RequestType0<VroElementPickInfo[], void, void>(
