...
import { uri, AutoWire, VroRestClient } from "vrealize-common"
...
export class SourceProvider {
    ...
    public async giveEntitySource(location: string): Promise<string> {
        ...
        if (!sourceParam || sourceParam.name !== "source" || !sourceParam.value ||
            !sourceParam.value.string || !sourceParam.value.string.value) {
